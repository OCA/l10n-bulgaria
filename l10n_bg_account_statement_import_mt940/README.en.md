...
**Module:** `l10n_bg_account_statement_import_mt940` | **Version:** 18.0.1.0.0 | **License:** LGPL-3 | **Category:** ?

## Overview

Part of the **l10n-bulgaria-oca** repository — see the repo-level README for context.
